...
def process_team_data():
   ...
   for i in range(len(df)):
      ...
      for j in range(len(member_names)):
         ...
         student, created = Student.objects.get_or_create(student_name=member_names[j], team=team)
...
def process_team_data_registration():
   dtype_dict = {
      "TEAM_ID": int,
      "TEAM_NAME": str,
      "NUMBER_OF_MEMBERS": int,
